...
//Имя
let tooltipName = 'Ashwariya Singh'
//Телефон
let tooltipPhone = '+91 XXXX XXX XXX'

let tooltipStyle = '<style>.input-group{position:relative;}.input-group input{box-sizing: border-box!important;padding-left:35px!important;width:100%;box-sizing:border-box;}.input-group:before{content:attr(data-content)"";position:absolute;top:-15px;'+tooltipPosition+':0;background:'+tooltipColor+';color:#fff;border-radius:5px;padding:3px 5px;font-family: Arial;font-size: 14px}.tooltip-hide.input-group:before{display: none;}</style>'
